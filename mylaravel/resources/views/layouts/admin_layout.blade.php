...
<link rel="stylesheet" href="{{ URL::asset('css/bootstrap_data_table.css') }}">
...
<script type="text/javascript" src="{{ URL::asset('js/jquery_data_table.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('js/bootstrap_data_table.js') }}"></script>
...
<div class="wrapper">
    <div class="sidebar" data-color="orange" data-image="{{ URL::asset('img/sidebar-5.jpg') }}">
